...
{
	[Register ("iPhoneSessionDetailViewController")]
	partial class iPhoneSessionDetailViewController
	{
		[Outlet]
		MonoTouch.UIKit.UIScrollView scrollView { get; set; }

		[Outlet]
		MonoTouch.UIKit.UIImageView technologyImage { get; set; }
		...
		[Outlet]
		MonoTouch.UIKit.UILabel sessionRoomLabel { get; set; }

		[Outlet]
		MonoTouch.UIKit.UIButton sessionSpeakerNameButton { get; set; }

		[Outlet]
		MonoTouch.UIKit.UILabel sessionTechnologyLabel { get; set; }
