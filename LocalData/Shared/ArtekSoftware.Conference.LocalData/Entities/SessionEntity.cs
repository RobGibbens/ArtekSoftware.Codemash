...
{
  [MapTo("session")]
  public class SessionEntity : CSObject<SessionEntity, string>
  {
    ...
    public string TwitterHashTag { get { return (string)GetField("TwitterHashTag"); } set { SetField("TwitterHashTag", value); } }
