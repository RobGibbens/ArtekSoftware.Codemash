...
namespace ArtekSoftware.Conference.Data.Tests.Int
{
  ...
  public class SessionRepositoryTests
  {
    ...
    public void Test()
    {
      ...
      var localRepository = new LocalSessionRepository();
      ...
      var repository = new SessionRepository(remoteRepository, localRepository, networkStatusCheck.Object, testFlightProxy, restClient, remoteConfiguration, conferenceSlug);
